...
from ware_ops_algos.algorithms import GreedyItemAssignment, ExactTSPRoutingDistance
...
class IOPVRPLoader(DataLoader):
    ...
    def __init__(
            ...
            storage_location_width_m: float = 1.3,
...
def main():
    ...
    order_list_online = instances_base / "IOPVRP" / "OrderList_LargeProblems_1_1.txt"
    order_lines_online = instances_base / "IOPVRP" / "OrderLineList_LargeProblems_1_1.txt"

    loader_online = IOPVRPLoader(
        instances_dir=DATA_DIR / "IOPVRP",
