...
from ware_ops_algos.domain_models import BaseWarehouseDomain, datacard_from_instance, save_card_yaml
...
@hydra.main(config_path="config", config_name="ibrsp_config")
def main(cfg: DictConfig):
    ...
    save_card_yaml(dc, r"C:\Users\zm0714\Documents\Projekte\ware_ops_sim\experiments\kris.yaml")
    ...
    #     sim.reset(hooks=[picker_AHarrival_hook, pre_shift_start_hook])
    #     sim.run()
