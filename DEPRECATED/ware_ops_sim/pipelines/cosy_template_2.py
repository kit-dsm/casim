...
class Evaluation(BaseComponent):
    ...
    def constraints(cls) -> Sequence[Callable[..., bool]]:
        ...
        return [
            lambda vs: problem_type_constraint(vs, SUBPROBLEMS, cls._data_card, cls._models, _get_classes),
            lambda vs: feature_constraint(vs, cls._data_card, cls._models, _get_classes),
            lambda vs: batching_loader_constraint(vs, SUBPROBLEMS, cls._data_card, PickListProvider, _get_classes),
